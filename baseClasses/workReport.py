...
class WorkReport:
    def __init__(self, id: int = 0, workOrderID: int = 0, description: str = "", contractorID: int = 0, employeeID: int = 0, date: str = "", cost: int = 0, comment: str = ""):
        self.id: int = id
    ...
    def __repr__(self) -> str:
        return f"WorkReport(id={self.id}, workOrderID={self.workOrderID}, employeeID={self.employeeID}, description={self.description}, date={self.date}, cost={self.cost}, comment={self.comment})"
